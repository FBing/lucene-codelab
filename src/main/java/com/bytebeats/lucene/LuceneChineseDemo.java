...
public class LuceneChineseDemo {

	private String indexPath = "D:/Lucene_Test/chinese/";
	...
	public void index() throws IOException {
		...
		addDoc(writer, "Lucene 实战", "9900333X");
		addDoc(writer, "计算机编程艺术", "9900333X");
	...
	public static void main(String[] args) {
		...
		try {
//			new LuceneChineseDemo().index();
			new LuceneChineseDemo().search();
		} catch (IOException e) {
			e.printStackTrace();
